...
<ul class=\"nav nav-pills nav-stacked\">
  ";
        // line 6
        if (isset($context["liste_articles"])) { $_liste_articles_ = $context["liste_articles"]; } else { $_liste_articles_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_liste_articles_);
