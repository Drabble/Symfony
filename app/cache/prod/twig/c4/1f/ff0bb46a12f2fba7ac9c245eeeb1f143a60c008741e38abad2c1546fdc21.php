...
";
  ...
  <i>Par ";
        // line 12
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_article_, "auteur"), "html", null, true);
        echo ", le ";
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($_article_, "date"), "d/m/Y"), "html", null, true);
        echo "</i>
  ...
  <div class=\"well\">
    ";
        // line 15
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_article_, "contenu"), "html", null, true);
        echo "
  </div>
  ...
  <p>
    ...
    <a href=\"";
        // line 23
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("testblog_modifier", array("id" => $this->getAttribute($_article_, "id"))), "html", null, true);
        echo "\" class=\"btn\">
      <i class=\"icon-edit\"></i>
      Modifier l'article
    </a>
    <a href=\"";
        // line 27
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("testblog_supprimer", array("id" => $this->getAttribute($_article_, "id"))), "html", null, true);
        echo "\" class=\"btn\">
