...
class __TwigTemplate_59dff48bbf8751c66b17a42bdec93c627ad90548fa55a16b8bc7e18b8f53f5f9 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_f741601ec679f27c79395e96aade107da08f91f102aa50bade318885ae7d2c2f"] = $this;
        // line 5
...
";
    ...
    ";
        // line 80
        echo $context["__internal_f741601ec679f27c79395e96aade107da08f91f102aa50bade318885ae7d2c2f"]->getdisplay_timeline(("timeline_" . $this->getContext($context, "token")), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getContext($context, "colors"));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children"))) {
            ...
            ";
                // line 90
                echo $context["__internal_f741601ec679f27c79395e96aade107da08f91f102aa50bade318885ae7d2c2f"]->getdisplay_timeline(("timeline_" . $this->getAttribute($this->getContext($context, "child"), "token")), $this->getContext($context, "events"), $this->getContext($context, "colors"));
                echo "
        ";
            }
...
";
        // line 406
        echo $context["__internal_f741601ec679f27c79395e96aade107da08f91f102aa50bade318885ae7d2c2f"]->getdump_request_data($this->getContext($context, "token"), $this->getContext($context, "profile"), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 411
                echo $context["__internal_f741601ec679f27c79395e96aade107da08f91f102aa50bade318885ae7d2c2f"]->getdump_request_data($this->getAttribute($this->getContext($context, "child"), "token"), $this->getContext($context, "child"), $this->getAttribute($this->getAttribute($this->getContext($context, "child"), "getcollector", array(0 => "time"), "method"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
...
";
    ...
    public function getdump_request_data($_token = null, $_profile = null, $_events = null, $_origin = null)
    {
        ...
        try {
            // line 450
            $context["__internal_6e7318ab5d1ba8e9b4b3658011ae4b5a460790c6cf830fc090785f7f8baadb0c"] = $this;
            // line 451
            echo "                {
                    \"id\": \"";
            // line 452
...
";
            // line 455
            echo $context["__internal_6e7318ab5d1ba8e9b4b3658011ae4b5a460790c6cf830fc090785f7f8baadb0c"]->getdump_events($this->getContext($context, "events"));
            echo "
                    ]
                }
";
